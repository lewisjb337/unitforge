...
public partial class DataStorageConversion : ComponentBase
{
    [Inject]
    public IDataStorageConversionService? DataStorageConversionService { get; set; }

    private readonly List<string> _fromUnits = [..UnitCategories.Categories["Data"]];
    private readonly List<string> _toUnits = [..UnitCategories.Categories["Data"]];
    ...
    private void Recalculate()
    {
        ...
        _outputValue = double.TryParse(_inputValue, out var inputValue) ? 
            DataStorageConversionService!.Convert(inputValue, _fromUnit, _toUnit).ToString(CultureInfo.InvariantCulture) : 
            "Invalid input";
    }
